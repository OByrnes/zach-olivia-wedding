...
export default function Footer() {
  ...
  return (
    <footer className="absolute end-0 bottomalign-center justify-center w-full z-50 bg-deep-cove-100 dark:bg-deep-cove-950 flex md:space-x-6 shadow-lg">
      ...
      <NavLinks
        ...
        className=" hover:underline flex space-x-4"
      >
        <span>
          <svg
